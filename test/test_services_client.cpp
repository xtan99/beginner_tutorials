...
TEST_F(CLASSNAME(test_services_client, RMW_IMPLEMENTATION), test_add_noreqid) {
  ...
  auto client = node->create_client<beginner_tutorials::srv::PrintNewString>("add_two_ints_noreqid");
  auto request = std::make_shared<beginner_tutorials::srv::PrintNewString::Request>();
  request->s = "Message";
...
TEST_F(CLASSNAME(test_services_client, RMW_IMPLEMENTATION), test_add_reqid) {
  ...
  auto client = node->create_client<beginner_tutorials::srv::PrintNewString>("add_two_ints_reqid");
  auto request = std::make_shared<beginner_tutorials::srv::PrintNewString::Request>();
  request->s = "Message";
...
TEST_F(CLASSNAME(test_services_client, RMW_IMPLEMENTATION), test_return_request) {
  ...
  auto result = client->async_send_request(
    request,
    [](rclcpp::Client<beginner_tutorials::srv::PrintNewString>::SharedFutureWithRequest future) {
