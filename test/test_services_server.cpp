...
void handle_add_two_ints_noreqid(
  const std::shared_ptr<beginner_tutorials::srv::PrintNewString::Request> request,
  std::shared_ptr<beginner_tutorials::srv::PrintNewString::Response> response)
{
...
void handle_add_two_ints_reqid(
  ...
  const std::shared_ptr<beginner_tutorials::srv::PrintNewString::Request> request,
  const std::shared_ptr<beginner_tutorials::srv::PrintNewString::Response> response)
{
  (void)request_header;
  response->new_string= request->s;
}
...
private:
  std::shared_ptr<rclcpp::Service<beginner_tutorials::srv::PrintNewString>> impl_;
...
int main(int argc, char ** argv)
{
  ...
  auto service_noreqid = node->create_service<beginner_tutorials::srv::PrintNewString>(
    "add_two_ints_noreqid", handle_add_two_ints_noreqid);

  auto service_reqid = node->create_service<beginner_tutorials::srv::PrintNewString>(
    "add_two_ints_reqid", handle_add_two_ints_reqid);

  auto service_return_req = node->create_service<beginner_tutorials::srv::PrintNewString>(
  ...
  auto derefed_cb_with_handle = node->create_service<beginner_tutorials::srv::PrintNewString>(
    "add_two_ints_defered_cb_with_handle",
    [node, &timer](
      const std::shared_ptr<rclcpp::Service<beginner_tutorials::srv::PrintNewString>> handle,
      const std::shared_ptr<rmw_request_id_t> request_header,
      const std::shared_ptr<beginner_tutorials::srv::PrintNewString::Request> request)
    {
